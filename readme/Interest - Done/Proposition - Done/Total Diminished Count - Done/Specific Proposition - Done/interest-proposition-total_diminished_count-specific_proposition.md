In this example, we will get the `Total Diminished Count` where the `Proposition` is "Root". This shows us how to get the `Total Diminished Count` for any case where we are exactly specifying the `Proposition`.
