In this example, we will get the sum of `Diminished Activity Counts` where the `Proposition` is "Level 2" and its children, and the `Activity Type` contains the text "Checkout -".
