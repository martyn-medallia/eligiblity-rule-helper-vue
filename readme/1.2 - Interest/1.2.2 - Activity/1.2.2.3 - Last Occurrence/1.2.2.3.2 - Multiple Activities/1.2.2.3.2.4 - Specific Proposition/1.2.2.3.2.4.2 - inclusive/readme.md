In this example, we will get the sum of `Last Occurrences` where the `Proposition` is "Level 2" and its children, and the `Activity Type` contains the text "Checkout -".
